...
data class Profilering(
    ...
    @get:JsonProperty("type", required = true) val type: Profilering.Type,
    ...
    @get:JsonProperty("jobbetSammenhengendeSeksAvTolvSisteMnd", required = true) val jobbetSammenhengendeSeksAvTolvSisteMnd: kotlin.Boolean,

    @get:JsonProperty("alder") val alder: kotlin.Int? = null
) {
