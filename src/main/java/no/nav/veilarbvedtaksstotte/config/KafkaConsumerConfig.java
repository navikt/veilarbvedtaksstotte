...
public class KafkaConsumerConfig {
    ...
    public AvsluttOppfolgingConsumer.ConsumerParameters avsluttOppfolgingConsumerConsumerParameters() {
        return new AvsluttOppfolgingConsumer.ConsumerParameters("aapen-fo-endringPaaAvsluttOppfolging-v1-" + requireKafkaTopicEnv());
    }
    ...
    public OppfolgingsbrukerEndringConsumer.ConsumerParameters oppfolgingsbrukerEndringConsumerParameters() {
        return new OppfolgingsbrukerEndringConsumer.ConsumerParameters("aapen-fo-endringPaaOppfoelgingsBruker-v1-" + requireKafkaTopicEnv());
    }
