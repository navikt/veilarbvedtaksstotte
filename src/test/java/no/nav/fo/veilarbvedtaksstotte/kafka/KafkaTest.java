...
public abstract class KafkaTest {
    ...
    @ClassRule
    public static KafkaEmbedded embeddedKafka = new KafkaEmbedded(1, true, KAFKA_TEST_TOPIC);
    ...
    public static void configureKafkaBroker() throws Exception {
        ...
        ContainerProperties containerProperties = new ContainerProperties(KAFKA_TEST_TOPIC);
        ...
        kafkaTemplate.setDefaultTopic(KAFKA_TEST_TOPIC);
