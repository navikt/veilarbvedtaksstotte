...
import no.nav.veilarbvedtaksstotte.klagebehandling.client.KabalDTO;
...
public class ClientTestConfig {
    ...
    public VeilarboppfolgingClient oppfolgingClient() {
        return new VeilarboppfolgingClient() {
            ...
            public Optional<OppfolgingsenhetDTO> hentOppfolgingsenhet(Fnr fnr) {
                OppfolgingsenhetDTO enhet = new OppfolgingsenhetDTO();
                enhet.setEnhetId(TEST_OPPFOLGINGSENHET_ID);
                enhet.setNavn(TEST_OPPFOLGINGSENHET_NAVN);
    ...
    @Bean
    public KabalClient kabalClient() {
        return new KabalClient() {
            @Override
            public void sendKlageTilKabal(KabalDTO kabalDto) {
            }
