...
public class KafkaConsumerServiceTest {
    ...
    public void skal_ikke_oppdatere_enhet_hvis_enhet_er_lik_for_endring_pa_oppfolgingsbruker() {
        ...
        when(vedtaksstotteRepository.hentUtkast(TEST_AKTOR_ID)).thenReturn(UtkastetVedtak.builder().oppfolgingsenhetId(enhet).build());
    ...
    public void skal_oppdatere_enhet_hvis_enhet_er_ulik_for_endring_pa_oppfolgingsbruker() {
        ...
        when(vedtaksstotteRepository.hentUtkast(TEST_AKTOR_ID)).thenReturn(UtkastetVedtak.builder().oppfolgingsenhetId(TEST_OPPFOLGINGSENHET_ID).build());
