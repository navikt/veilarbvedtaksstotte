...
class Gjeldende14aVedtakServiceTest @Autowired constructor(
    transactionTemplate: TransactionTemplate
) : AbstractVedtakIntegrationTest() {
    ...
    private final var kafkaProducerService: KafkaProducerService = Mockito.mock(KafkaProducerService::class.java)
    private final var arenaVedtakService: ArenaVedtakService = Mockito.mock(ArenaVedtakService::class.java)

    val oppfolgingsvedtak14aService =
    ...
    fun `vedtak er gjeldende dersom vedtak er fattet i innevarende oppfolgingsperiode`() {
        ...
        `when`(oppfolgingsvedtak14aService.siste14aVedtak(TestData.TEST_FNR)).thenReturn(
            Siste14aVedtak(
                aktorId = AktorId.of(TestData.TEST_AKTOR_ID),
    ...
    fun `hentGjeldende14aVedtak returnerer null dersom person ikke har vedtak`() {
        ...
        `when`(oppfolgingsvedtak14aService.siste14aVedtak(TestData.TEST_FNR)).thenReturn(null)
